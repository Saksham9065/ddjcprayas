  ...
  return (
    <section id="youth" className="py-10 md:py-16 bg-slate-50 border-b border-slate-200">
      <div className="container mx-auto px-4 md:px-6 max-w-6xl">
        <Reveal>
          <SectionHeading
            eyebrow={t("For Youth", "युवाओं के लिए")}
            title={t("Youth Empowerment", "युवा सशक्तिकरण")}
            subtitle={t("Know your rights. Know your Constitution. Know your power.", "अपने अधिकार जानें। अपना संविधान जानें। अपनी शक्ति जानें।")}
          />
        </Reveal>
          ...
          <Reveal>
            <div className="h-full bg-navy rounded-3xl p-8 md:p-10 text-white flex flex-col justify-center relative overflow-hidden">
              ...
              <p className="text-white/70 text-sm leading-relaxed mt-3 mb-7">
                {t("The Youth Hub builds a generation that understands the Constitution and stands up for dignity in every village and ward.", "युवा हब एक ऐसी पीढ़ी का निर्माण करता है जो संविधान को समझती है और हर गाँव और परिसर में गरिमा के लिए खड़ी होती है।")}
              </p>
              <Link
              ...
              >
                {t("Visit Youth Hub", "युवा हब देखें")} <ArrowRight size={14} />
              </Link>
            </div>
          </Reveal>
            ...
            <div className="h-full rounded-3xl border border-slate-200 bg-white p-6 md:p-7">
              <div className="flex items-center justify-between mb-5">
                ...
                <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400">
                  {t("Watch and Share", "देखें और साझा करें")}
                </span>
              </div>
                ...
                {VIDEOS.map((v) => (
                  ...
                  >
                    ...
                    <p className="text-sm font-bold text-navy leading-snug group-hover:text-gold transition-colors">
                      {language === "en" ? v.titleEn : v.titleHi}
                    </p>
                  </a>
                ))}
              </div>
