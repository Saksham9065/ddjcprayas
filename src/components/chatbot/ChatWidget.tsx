      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="flex h-[480px] w-[320px] flex-col overflow-hidden rounded-2xl border border-white/10 bg-slate-900 shadow-2xl md:h-[520px] md:w-[360px]"
          >
            {/* Header */}
            <div className="flex items-center justify-between border-b border-white/10 bg-slate-900 px-3 py-2.5">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-xs font-bold text-white leading-tight">DDJC AI Assistant</h3>
              ...
              <div className="flex items-center gap-1">
                <button
                  onClick={handleClear}
                  className="rounded-md px-2 py-1 text-[10px] font-bold uppercase tracking-wide text-slate-300 transition hover:bg-white/10 hover:text-white"
                  type="button"
                >
                  Clear
                </button>
