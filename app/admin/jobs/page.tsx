...
export default function AdminJobsPage() {
  ...
  const columns: ColumnDef[] = [
    ...
    { key: "occupation", label: "व्यवसाय", render: (item) => String(item.occupation ?? "") },
    { key: "experience", label: "अनुभव", render: (item) => String(item.experience ?? "उपलब्ध नहीं") },
    { key: "position", label: "पद", render: (item) => (
      <span className="bg-slate-50 text-[#000000] px-2.5 py-1 rounded-md font-semibold text-[10px] border border-slate-100">
        {String(item.position ?? "उपलब्ध नहीं")}
      </span>
    )},
  ...
  return (
    <AdminPageShell
      ...
      description="DDJC वेबसाइट से नौकरी और करियर आवेदनों का प्रबंधन करें"
