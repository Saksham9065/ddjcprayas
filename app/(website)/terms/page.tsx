        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <p className="text-slate-600 text-base md:text-lg leading-relaxed">
            {isHindi
              ...
              : "By using the DDJC website, you agree to the following terms and conditions."}
          </p>
        </div>
          ...
          <div className="space-y-4 text-slate-700 text-sm md:text-base leading-relaxed">
            <p>
              {isHindi
                ...
                : "This website is for informational and educational purposes. The information provided is for general guidance only and does not constitute legal advice."}
            </p>
            <p>
              {isHindi
                ...
                : "DDJC strives for accuracy and timeliness of content, but makes no guarantees. Users should seek professional advice at their own discretion."}
            </p>
            <p>
              {isHindi
                ? "वेबसाइट का गैर-व्यावसायिक, गैर-विरोधी उपयोग ही अनुमति है। किसी भी प्रकार के दुरुपयोग पर कार्रवाई हो सकती है।"
                : "Non-commercial, non-offensive use of the website is permitted. Any misuse may result in action."}
            </p>
            <p>
              {isHindi
