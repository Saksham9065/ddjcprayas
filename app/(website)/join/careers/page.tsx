          ...
          {success ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                ...
                <div>
                  <label className="block text-[10px] md:text-xs font-bold uppercase text-slate-700 mb-1.5 md:mb-2">वर्तमान पेशा *</label>
                  <div className="flex flex-wrap gap-3 md:gap-4">
                    {[
                      { value: "Student", label: "छात्र" },
                      { value: "Working Professional", label: "पेशेवर" },
                ...
                <div>
                  <label className="block text-[10px] md:text-xs font-bold uppercase text-slate-700 mb-1.5 md:mb-2">अनुभव *</label>
                  <select
                    name="experience"
                    required
                    ...
                    onChange={handleChange}
                      className="w-full px-3 py-2.5 md:px-4 md:py-3.5 rounded-xl border border-slate-200 text-xs md:text-sm focus:outline-none focus:border-[#000000]"
                  >
                    <option value="">अनुभव स्तर चुनें</option>
                    <option value="Fresher">फ्रेशर (0-1 वर्ष)</option>
                    <option value="1-2 Years">1-2 वर्ष</option>
                    <option value="2-3 Years">2-3 वर्ष</option>
                    <option value="3-5 Years">3-5 वर्ष</option>
                    <option value="5+ Years">5+ वर्ष</option>
                  </select>
                </div>

                <div>
                  <label className="block text-[10px] md:text-xs font-bold uppercase text-slate-700 mb-1.5 md:mb-2">आवेदन कर रहे पद *</label>
                  <select
                    name="position"
                    required
                  ...
                  >
                    ...
                    <option value="Legal Advocate">कानूनी वकील</option>
                    <option value="Field Coordinator">फील्ड समन्वयक</option>
                    <option value="Community Outreach Officer">सामुदायिक आउटरीच ऑफिसर</option>
                    <option value="Research Analyst">रिसर्च एनालिस्ट</option>
                  </select>
                </div>
                  ...
                  >
                    ...
                    {formData.resume ? (
                      ...
                      <div className="space-y-2 md:space-y-3">
                        ...
                        <div>
                          <p className="text-xs md:text-sm font-bold text-slate-700">रिज्यूमे अपलोड करने के लिए क्लिक करें</p>
                          <p className="text-[10px] md:text-xs text-slate-500 mt-1">PDF, DOC, DOCX (अधिकतम 5MB) समर्थित</p>
                        </div>
                      </div>
                    )}
                  </div>
                ...
                <div>
                  ...
                  <p className="text-[10px] md:text-xs text-slate-500 mb-1.5 md:mb-2">आप DDJC में क्यों जुड़ना चाहते हैं और आपका पुराना अनुभव (यदि कोई हो) क्या है?</p>
                  <textarea
                    name="statement"
                    required
                    rows={3}
                    ...
                    onChange={handleChange}
                      className="w-full px-3 py-2.5 md:px-4 md:py-3.5 rounded-xl border border-slate-200 text-xs md:text-sm focus:outline-none focus:border-[#000000]"
                    placeholder="बताएं कि आप DDJC में क्यों जुड़ना चाहते हैं और अपना प्रासंगिक पुराना अनुभव साझा करें..."
                  />
                </div>
